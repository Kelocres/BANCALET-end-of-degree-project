...
public class UI_EditorCartes : UI_Menu
{
    ...
    public Character_Letter receiver = Character_Letter.Miller;
    public Text txt_receiver;

    //Per a retornar al menú de cartes si es vol
    public UI_MenuCartes voreCartes;
    ...
    {
        Debug.Log("UI_EditorCartes StartLetter()");
    ...
    {
        Debug.Log("UI_EditorCartes SendLetter()");
        btnStart.interactable = true;
        btnSend.interactable = false;
        btnDelete.interactable = false;
    ...
    {
        Debug.Log("UI_EditorCartes DeleteLetter()");
        btnStart.interactable = true;
        btnSend.interactable = false;
        btnDelete.interactable = false;
    ...
    public void Tornar()
    {
        if(voreCartes == null)
        {
            Debug.Log("UI_EditorCartes Tornar() UI_MenuCartes == null!!!");
            return;
        }

        //Si hi ha carta, es borra
        if (btnDelete.interactable == true) DeleteLetter();

        ChangeMenu(voreCartes);
    }

    public void SetReceiver(Character_Letter cl)
    {
        receiver = cl;

        if(txt_receiver == null)
        {
            Debug.Log("UI_EditorCartes SetReceiver() txt_receiver == null!!!");
            return;
        }

        if (cl == Character_Letter.Miller) txt_receiver.text = "Destinatari: Molinera";
        else if (cl == Character_Letter.RetiredMan) txt_receiver.text = "Destinatari: Jubilat";
        else if (cl == Character_Letter.PC_Sister) txt_receiver.text = "Destinatari: Germana";
