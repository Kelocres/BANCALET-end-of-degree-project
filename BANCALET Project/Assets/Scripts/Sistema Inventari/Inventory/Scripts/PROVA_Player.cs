...
public class PROVA_Player : MonoBehaviour
{

    public SO_InventoryObject inventory;
    public SO_InventoryObject equipment;
    ...
    public void OnTriggerEnter(Collider other)
    {
        ...
        var item = other.GetComponent<PROVA_GroundItem>();
        if (item)
        {
            ...
            if (inventory.AddItem(new Item(item.item), 1)) //Tutorial 7
            {
                Destroy(other.gameObject);
            }
